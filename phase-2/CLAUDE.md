...
### Technology Stack
For this project, we will use the following technology stack:
...
Use the following specialized agents for different aspects of development:

- **Auth Agent**: For authentication implementation using Better Auth
- **Frontend Agent**: For frontend development (e.g., Next.js components, pages, and API routes)
- **DB Agent**: For database design, schema creation, and operations using SQLModel and Neon Serverless PostgreSQL
- **Backend Agent**: For FastAPI development, including API endpoints, business logic, and data validation

### Phase II: Todo Full-Stack Web Application Requirements
